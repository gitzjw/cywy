...
//		$db_config ["hostname"] = "bdm186320458.my3w.com"; //服务器地址
//		$db_config ["username"] = "bdm186320458"; //数据库用户名
//		$db_config ["password"] = "qiangdiao9090"; //数据库密码
//		$db_config ["database"] = "bdm186320458_db"; //数据库名称
