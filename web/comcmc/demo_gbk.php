...
function registDetailInfo()
{
	...
	$eName = "北京社源传媒广告公司";
	$linkMan = "张健";
	$phoneNum = "010-57385720-709";
	$mobile = "13641142052";
	$email = "zhangjian@bx2005.com";
	$fax = "010-57385800-808";
	$address = "广渠路11号金泰国际大厦A508";
	$postcode = "10086";
...
function sendSMS()
{
	 ...
	 */
	$statusCode = $client->sendSMS(array('13641142052'),"手机验证码为：542781，感谢您进行手机绑定，该验证码10分钟内有效。如非本人操作，请忽略本信息【双井13社区】");
	echo "处理状态码:".$statusCode;
}
